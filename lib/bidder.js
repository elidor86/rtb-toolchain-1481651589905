...
var Bidder = function (req, res, next) {
    ...
    this.SanityCheck_MAX_DAILY_BIDs = 5000;
...
Bidder.prototype.populateBidReqData = function () {
    ...
    try {
        ...
        if (parsedurl.query) {
            bidReqData.URL_Query_Q = parsedurl.query.q || parsedurl.query.kw || parsedurl.query._nkw || parsedurl.query['field-keywords'] || parsedurl.query.k || parsedurl.query.keyword || parsedurl.query.find_desc || parsedurl.query.find || parsedurl.query.keywords;
        }
