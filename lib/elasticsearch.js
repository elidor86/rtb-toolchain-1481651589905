    ...
    return new Promise(function (fulfill, reject) {
        ...
        client.bulk({
            body: [
                ...
                {update: {_index: 'rtb', _type: 'campaigns', _id: data.campaignId, _retry_on_conflict: 50}},
                {script: 'ctx._source.Num_Of_BIDs_Sent += 1', upsert: {counter: 1}},

                {update: {_index: 'rtb', _type: 'dailyStat', _id: data.date, _retry_on_conflict: 50}},
...
Elasticsearch.fetchEs = function (body, ip, path, cb) {
