...
var pathToFile = global.appRoot + "/GeoIP2-City.mmdb";
...
function getGEOFile() {
    ...
    var loadFile = function () {
        try {
            setTimeout(function () {
                reader = new MMDBReader(pathToFile);
            }, 1000 * 2);
    ...
    try {
        ...
        fs.open(pathToFile, 'r', function (err, fd) {
            ...
            if (err) {
                downloadFile("https://storage.googleapis.com/tt-bucket/GeoIP2-City.mmdb", pathToFile, function (err) {
